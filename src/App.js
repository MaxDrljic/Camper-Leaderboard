        ...
        <Table striped bordered condensed hover className="colorBlack">
          <thead>
            <tr>
              <th>#</th>
              <th>Camper Name</th>
              <th className="points30Days" onClick={(event)=> this.pointChange(true)}>Points in 30 Days {current && (<i className="fa fa-caret-down"></i>)}</th>
              <th className="allTimePoints" onClick={(event)=> this.pointChange(false)}>All Time Points {current === false && (<i className="fa fa-caret-down"></i>)}</th>
            </tr>
          </thead>
          <tbody>
